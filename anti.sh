...
cat << EOF
 ...
 $f1  @pic5all    $f2 @pic5all    $f3  @pic5all   $f4  @pic5all    $f5 @pic5all    $f6 @pic5all  $rst

EOF
echo -e "                \e[100m                DJ script           \e[00;37;40m"
echo -e "               \e[01;34m                 By DJ                \e[00;37;40m"
echo ""
cat << EOF
 $bld$f1 @pic5all   $f2 @pic5all   $f3  @pic5all    $f4 @pic5all   $f5 @pic5all    $f6  @pic5all  $rst
...
echo ""
echo -e "\033[38;5;208m     > Channel : @pic4all                         \033[0;00m"
echo -e "\033[38;5;208m     > Developer : @pic5all                        \033[0;00m"
echo -e "\033[38;5;208m     > Bot ID : @pic5all                         \033[0;00m"
...
TMUX= tmux new-session -d -s $BOT "./dj.sh"
sleep 1.3
...
# Space invaders thanks to @pic5all
f=3 b=4
for j in f b; do
  for i in {0..7}; do
    printf -v $j$i %b "\e[${!j}${i}m"
